"""
Diffusion Layers for Time Series Forecasting

This module provides diffusion-related layers for probabilistic forecasting.
"""
...
def get_torch_trans(heads=8, layers=1, channels=64):
    """Get PyTorch transformer encoder."""
...
class ResidualBlock(nn.Module):
    """Residual block for CSDI diffusion model."""
        ...
        if is_linear:
            try:
                ...
                self.time_layer = LinearAttentionTransformer(
                    dim=channels, depth=1, heads=nheads, max_seq_len=256
                )
