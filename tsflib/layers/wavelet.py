"""
Multiwavelet-based layers for time series forecasting.

This module provides multiwavelet transform-based attention mechanisms
for capturing multi-resolution patterns in time series data.
"""
...
from torch import nn as nn_module, einsum, diagonal
