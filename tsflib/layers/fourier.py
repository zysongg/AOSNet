"""
Fourier-based layers for time series forecasting.

This module provides Fourier transform-based attention mechanisms
for capturing frequency-domain patterns in time series data.
"""
